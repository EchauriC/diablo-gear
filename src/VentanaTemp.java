 ...
 * @author EchauriC
 */
public class VentanaTemp extends javax.swing.JFrame {

    boolean devMode = true;
    StatsParser statsParser;
    ArrayList<Stat> originalesPrincipales;
    ArrayList<Stat> originalesSecundarios;
    ...
    public VentanaTemp() {
        ...
        try {
            ...
            if(devMode) Logger.getLogger(VentanaTemp.class.getName()).log(Level.SEVERE, null, ex);
        ...
        DefaultComboBoxModel<Stat> model = new DefaultComboBoxModel(statsParser.getPrincipalesAsStatArrayList().toArray());
        JComboBox testCombo = new JComboBox();
        testCombo.setModel(model);
        testCombo.addActionListener((ActionEvent e) -> {
            System.out.println(testCombo.getSelectedItem());
        });
        
        jPanel3.add(testCombo);
        jPanel3.revalidate();
        jPanel3.repaint();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaTemp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaTemp().setVisible(true);
            }
        });
    }
